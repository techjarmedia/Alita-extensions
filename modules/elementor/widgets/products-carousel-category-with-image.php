 ...
 * @since 1.0.0
 */
class Alita_Elementor_Products_Carousel_Categories_With_Image extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_products_carousel_category_with_image_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Products Carousel Categories and Image', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'description',
            [
                'label'         => esc_html__('Enale product description ', 'Alita-extensions'),
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Products_Carousel_Categories_With_Image );