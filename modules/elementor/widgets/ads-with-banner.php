 ...
 * @since 1.0.0
 */
class Alita_Elementor_Ads_with_banners_block extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_ads_with_banners_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Ads with banners block', 'Alita-extensions' );
    }
    ...
    $this->start_controls_section(
        ...
        $this->add_control(
            'ads_banners',
            [
                'label'  => esc_html__( 'Ads with banners block', 'Alita-extensions' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'description',
                        'label' => esc_html__( 'Description', 'Alita-extensions' ),
                        'type'  => Controls_Manager::TEXTAREA,
                        'placeholder' => esc_html__( 'Enter your link text here', 'Alita-extensions' ),
                    ],
                    [
                        'name'  => 'price',
                        'label' => esc_html__( 'Price', 'Alita-extensions' ),
                        'type'  => Controls_Manager::TEXT,
                        'placeholder' => esc_html__( 'Enter your link text here', 'Alita-extensions' ),
                    ],
                    [
                    ...
                    [
                        'name'  => 'banner_image',
                        'label' => esc_html__( 'Banner Image', 'Alita-extensions' ),
                        'type'  => Controls_Manager::MEDIA,
                        'placeholder' => esc_html__( 'Enter your link text here', 'Alita-extensions' ),
                    ],
                    [
                        'name'          => 'is_align_end',
                        'label'         => esc_html__( 'Banner Alignment', 'Alita-extensions' ),
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_ads_with_banners' ) ) {
            Alita_ads_with_banners( $args );
        }
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Ads_with_banners_block );