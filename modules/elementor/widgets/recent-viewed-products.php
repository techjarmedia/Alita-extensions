 ...
 * @since 1.0.0
 */
class Alita_Elementor_Recent_Vieved_Products extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_recent_viewed_products';
    }
    ...
    public function get_title() {
        return esc_html__( 'Recent Vieved Products', 'Alita-extensions' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Recent_Vieved_Products );