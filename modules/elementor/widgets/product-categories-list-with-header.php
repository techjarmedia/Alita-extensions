 ...
 * @since 1.0.0
 */
class Alita_Elementor_Products_Categories_List_With_Header_Image_Block extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_product_categories_list_with_header';
    }
    ...
    public function get_title() {
        return esc_html__( 'Products Categories List With Header Image', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(   
            'enable_header',
            [
                'label' => esc_html__( 'Enable Header', 'Alita-extensions' ),
        ...
        $this->add_control(   
            'columns',
            [
                'label' => esc_html__( 'Enter Columns', 'Alita-extensions' ),
                'type'  => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            'type',
            [
                'label' => esc_html__( 'Header Version', 'Alita-extensions' ),
                'type'  => Controls_Manager::SELECT,
                'options' => [
                    'v1' =>  esc_html__( 'Type 1', 'Alita-extensions' ),
                    'v2' =>  esc_html__( 'Type 2', 'Alita-extensions' )
                ],
            ]
        );
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_product_categories_list_with_header' ) ) {
            Alita_product_categories_list_with_header( $args );
        }

    }
}

Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Products_Categories_List_With_Header_Image_Block );