 ...
 * @since 1.0.0
 */
class Alita_Elementor_Products_Categorries_Block extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_home_categories_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Product Categories Block', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'enable_full_width',
            [
                'label' => esc_html__( 'Enable Fullwidth', 'Alita-extensions' ),
                'type'  => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__( 'Enable', 'Alita-extensions' ),
                'label_off' => esc_html__( 'Disable', 'Alita-extensions' ),
                'return_value'  => true,
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_home_categories_block' ) ) {
            Alita_home_categories_block( $args );
        }
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Products_Categorries_Block );