 ...
 * @since 1.0.0
 */
class Alita_Elementor_Ad_Block extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_ads_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Ad Block', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'ads_block',
            [
                'label'  => esc_html__( 'Ad block', 'Alita-extensions' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Ad_Block );