 ...
 * @since 1.0.0
 */
class Alita_Elementor_Products_List_Categories_Menu extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_product_categories_menu_list_elements';
    }
    ...
    public function get_title() {
        return esc_html__( 'Product List Categories Menu', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                'label'  => esc_html__( 'Product List Categories Menu', 'Alita-extensions' ),
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_product_categories_menu_list' ) ) {
            Alita_product_categories_menu_list( $args );
        }
    }
}
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Products_List_Categories_Menu );