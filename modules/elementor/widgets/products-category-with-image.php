 ...
 * @since 1.0.0
 */
class Alita_Elementor_Products_Categories_With_Image extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_products_category_with_image_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Products Categories Tabs and Image', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'section_class',
            [
                'label'         => esc_html__( 'Section Class', 'Alita-extensions' ),
                'type'          => Controls_Manager::TEXT,
                'placeholder'   => esc_html__( 'Enter Class', 'Alita-extensions' ),
            ]
        );
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_products_category_with_image' ) ) {
            Alita_products_category_with_image( $args );
        }
    }
}

Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Products_Categories_With_Image );