 ...
 * @since 1.0.0
 */
class Alita_Elementor_Products_One_Two_Block extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_products_1_2_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Products 1-2 Block', 'Alita-extensions' );
    }
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_products_1_2_block' ) ) {
            Alita_products_1_2_block( $args );
        }

    }
}

Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Products_One_Two_Block );