 ...
 * @since 1.0.0
 */
class Alita_Elementor_products_carousel_1 extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_products_carousel_1_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Products Carousel 1', 'Alita-extensions' );
    }
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_products_carousel_v5' ) ) {
            Alita_products_carousel_v5( $args, $carousel_args );
        }
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_products_carousel_1 );