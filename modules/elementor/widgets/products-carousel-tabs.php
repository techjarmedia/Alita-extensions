 ...
 * @since 1.0.0
 */
class Alita_Elementor_Products_Tabs_Elements extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_products_carousel_tabs';
    }
    ...
    public function get_title() {
        return esc_html__( 'Product Tabs Carousel', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'items_1200',
            [
                'label'         => esc_html__('Carousel: Items(1200 - 1440)', 'Alita-extensions'),
                'type'          => Controls_Manager::TEXT,
                'placeholder'   => esc_html__('Enter the number of items to display.', 'Alita-extensions'),
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Products_Tabs_Elements );