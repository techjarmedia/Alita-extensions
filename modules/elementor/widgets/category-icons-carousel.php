 ...
 * @since 1.0.0
 */
class Alita_Elementor_Category_Icon_Carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_category_icon_carousel';
    }
    ...
    public function get_title() {
        return esc_html__( 'Category Icon Carousel', 'Alita-extensions' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'       => '',
                'placeholder'   => esc_html__( 'Enter Number of Categories to display', 'Alita-extensions' ),
            ]
        );
        ...
        $this->add_control(
            'slugs',
            [
                'label'         => esc_html__( 'Include Slugs', 'Alita-extensions' ),
                'type'          => Controls_Manager::TEXT,
                'placeholder'   => esc_html__( 'Enter the slug seperate by comma(,)', 'Alita-extensions' ),
                'default'       => '',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'          => Controls_Manager::TEXT,
                'placeholder'   => esc_html__( 'Enter the ID \'s seperate by comma(,)', 'Alita-extensions' ),
                'default'       => '',
            ]
        );
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_home_category_icon_carousel' ) ) {
            Alita_home_category_icon_carousel( $args, $carousel_args );
        }
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Category_Icon_Carousel );