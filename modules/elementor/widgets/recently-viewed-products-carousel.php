 ...
 * @since 1.0.0
 */
class Alita_Elementor_Recently_Vieved_Products_Carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_recently_viewed_products_carousel';
    }
    ...
    public function get_title() {
        return esc_html__( 'Recently Vieved Products Carousel', 'Alita-extensions' );
    }
    ...
    protected function render() {
        ...
        if ( is_woocommerce_activated() ) {
            ...
            if( function_exists( 'Alita_recent_viewed_products_carousel' ) ) {
                Alita_recent_viewed_products_carousel( $section_args , $carousel_args );
            }
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Recently_Vieved_Products_Carousel );