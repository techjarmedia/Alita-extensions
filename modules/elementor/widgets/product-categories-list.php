 ...
 * @since 1.0.0
 */
class Alita_Elementor_Product_Categories_List_Block extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_product_categories_list_element';
    }
    ...
    public function get_title() {
        return esc_html__( 'Product Categories List', 'Alita-extensions' );
    }
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_product_categories_list' ) ) {
            Alita_product_categories_list( $args );
        }

    }
}

Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Product_Categories_List_Block );