 ...
 * @since 1.0.0
 */
class Alita_Elementor_Slider_With_Ads_Block extends Widget_Base {
    ...
    public function get_name() {
        return 'Alita_elementor_slider_with_ads_block';
    }
    ...
    public function get_title() {
        return esc_html__( 'Slider With Ads Block', 'Alita-extensions' );
    }
        ...
        $this->add_control(
            ...
            [
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'ad_image',
                        'label' => esc_html__( 'Ad image', 'Alita-extensions' ),
                        'type'  => Controls_Manager::MEDIA,
                    ],
                    [
                        'name'  => 'ad_text',
                        'label' => esc_html__( 'Ad text', 'Alita-extensions' ),
    ...
    protected function render() {
        ...
        if( function_exists( 'Alita_slider_with_ads_block' ) ) {
            Alita_slider_with_ads_block( $args );
        }
...
Plugin::instance()->widgets_manager->register_widget_type( new Alita_Elementor_Slider_With_Ads_Block );