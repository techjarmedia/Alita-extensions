<?php
if ( ! function_exists( 'Alita_vc_products_list_block' ) ) :

function Alita_vc_products_list_block( $atts, $content = null ) {
    ...
    $args = apply_filters( 'Alita_vc_products_list_block_args', array(
        'section_class'             => '',
        'section_title'             => $title,
        'type'                      => $type,
...
add_shortcode( 'Alita_vc_products_list' , 'Alita_vc_products_list_block' );
