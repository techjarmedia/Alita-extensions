<?php
if ( ! function_exists( 'Alita_vc_products_2_1_2_block' ) ) :

function Alita_vc_products_2_1_2_block( $atts, $content = null ) {
...
add_shortcode( 'Alita_products_2_1_2' , 'Alita_vc_products_2_1_2_block' );
