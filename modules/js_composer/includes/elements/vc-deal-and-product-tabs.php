<?php
if ( ! function_exists( 'Alita_vc_deal_and_product_tabs' ) ) :

function Alita_vc_deal_and_product_tabs( $atts, $content = null ) {
...
add_shortcode( 'Alita_vc_deal_and_product_tab' , 'Alita_vc_deal_and_product_tabs' );
