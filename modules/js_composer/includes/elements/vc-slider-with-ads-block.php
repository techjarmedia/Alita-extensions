...
if ( ! function_exists( 'Alita_vc_slider_with_ads_block' ) ) :

    function Alita_vc_slider_with_ads_block( $atts, $content = null ){
    ...
    add_shortcode( 'Alita_slider_with_ads_block' , 'Alita_vc_slider_with_ads_block' );
