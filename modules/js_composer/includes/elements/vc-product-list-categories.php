...
if ( ! function_exists( 'Alita_product_list_categories_element' ) ) :

	function Alita_product_list_categories_element( $atts, $content = null ){
	...
	add_shortcode( 'Alita_product_list_categories' , 'Alita_product_list_categories_element' );
