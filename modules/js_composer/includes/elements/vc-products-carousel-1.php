<?php
if ( ! function_exists( 'Alita_vc_products_carousel_1_block' ) ) :

function Alita_vc_products_carousel_1_block( $atts, $content = null ) {
    ...
    if( function_exists( 'Alita_products_carousel_v5' ) ) {
        ob_start();
        Alita_products_carousel_v5( $args['section_args'], $args['carousel_args'] );
        $html = ob_get_clean();
    }
...
add_shortcode( 'Alita_vc_products_carousel_1' , 'Alita_vc_products_carousel_1_block' );
