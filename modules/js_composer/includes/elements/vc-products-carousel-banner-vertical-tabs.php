<?php
if ( ! function_exists( 'Alita_vc_products_carousel_banner_vertical_tabs_block' ) ) :

function Alita_vc_products_carousel_banner_vertical_tabs_block( $atts, $content = null ) {
...
add_shortcode( 'Alita_vc_products_carousel_banner_vertical_tabs' , 'Alita_vc_products_carousel_banner_vertical_tabs_block' );
