...
if ( ! function_exists( 'Alita_vc_ads_with_banners_block' ) ) :

    function Alita_vc_ads_with_banners_block( $atts, $content = null ){
    ...
    add_shortcode( 'Alita_ads_with_banners_block' , 'Alita_vc_ads_with_banners_block' );
