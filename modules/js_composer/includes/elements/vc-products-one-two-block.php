...
if ( ! function_exists( 'Alita_products_1_2_block_element' ) ) :

	function Alita_products_1_2_block_element( $atts, $content = null ){
	...
	add_shortcode( 'Alita_products_1_2_block' , 'Alita_products_1_2_block_element' );
