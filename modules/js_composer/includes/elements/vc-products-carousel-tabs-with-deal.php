<?php
if ( ! function_exists( 'Alita_products_tabs_carousel_with_deal_element' ) ) {

	function Alita_products_tabs_carousel_with_deal_element( $atts, $content = null ){
...
add_shortcode( 'Alita_products_tabs_carousel_with_deal' , 'Alita_products_tabs_carousel_with_deal_element' );
