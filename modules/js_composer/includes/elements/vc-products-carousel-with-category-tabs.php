<?php
if ( ! function_exists( 'Alita_vc_products_carousel_with_category_tabs_block' ) ) :

function Alita_vc_products_carousel_with_category_tabs_block( $atts, $content = null ) {
...
add_shortcode( 'Alita_vc_products_carousel_with_category_tabs' , 'Alita_vc_products_carousel_with_category_tabs_block' );
