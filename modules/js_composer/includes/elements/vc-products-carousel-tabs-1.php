<?php
if ( ! function_exists( 'Alita_products_tabs_carousel_1_element' ) ) {

	function Alita_products_tabs_carousel_1_element( $atts, $content = null ){
...
add_shortcode( 'Alita_products_tabs_carousel_1' , 'Alita_products_tabs_carousel_1_element' );
