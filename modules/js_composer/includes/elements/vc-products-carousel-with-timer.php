<?php
if ( ! function_exists( 'Alita_vc_products_carousel_with_timer_block' ) ) :

function Alita_vc_products_carousel_with_timer_block( $atts, $content = null ) {
    ...
    if( function_exists( 'Alita_products_carousel_with_timer' ) ) {
        ob_start();
        Alita_products_carousel_with_timer( $args['section_args'], $args['carousel_args'] );
        $html = ob_get_clean();
    }
...
add_shortcode( 'Alita_vc_products_carousel_with_timer' , 'Alita_vc_products_carousel_with_timer_block' );
