<?php
if ( ! function_exists( 'Alita_vc_products_6_1_with_categories_block' ) ) :

function Alita_vc_products_6_1_with_categories_block( $atts, $content = null ) {
...
add_shortcode( 'Alita_vc_products_6_1_with_categories' , 'Alita_vc_products_6_1_with_categories_block' );
