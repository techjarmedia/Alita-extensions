<?php
if ( ! function_exists( 'Alita_vc_products_category_with_image_block' ) ) :

function Alita_vc_products_category_with_image_block( $atts, $content = null ) {
...
add_shortcode( 'Alita_vc_products_category_with_image' , 'Alita_vc_products_category_with_image_block' );
