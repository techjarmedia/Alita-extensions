...
if ( ! function_exists( 'Alita_product_categories_menu_list_elements' ) ) :

    function Alita_product_categories_menu_list_elements( $atts, $content = null ){
    ...
    add_shortcode( 'Alita_product_categories_menu_list' , 'Alita_product_categories_menu_list_elements' );
