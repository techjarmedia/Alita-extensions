<?php
if ( ! function_exists( 'Alita_vc_products_6_1_block' ) ) :

function Alita_vc_products_6_1_block( $atts, $content = null ) {
	...
	$html = '';
	if( function_exists( 'Alita_products_6_1_block' ) ) {
		ob_start();
		Alita_products_6_1_block( $args );
		$html = ob_get_clean();
	}
...
add_shortcode( 'Alita_vc_products_6_1' , 'Alita_vc_products_6_1_block' );
