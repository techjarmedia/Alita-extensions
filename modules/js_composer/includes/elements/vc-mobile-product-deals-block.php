<?php
if ( ! function_exists( 'Alita_vc_deal_products_with_featured' ) ) :

function Alita_vc_deal_products_with_featured( $atts, $content = null ) {
...
add_shortcode( 'Alita_vc_mobile_deal_products_with_featured' , 'Alita_vc_deal_products_with_featured' );
